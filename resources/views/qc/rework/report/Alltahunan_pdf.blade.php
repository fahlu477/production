    ...
    <body> 
        ...
        <table style="width:1260px">
            <tr>
                ...
                <td style="font-weight:bold;">MAJALENGKA 2 TEST</td>
            </tr>
            <tr>
                <td rowspan='2'>1</td>
                <td rowspan='2'>Jan</td>
        ...
        <div class="tables-row">
            <div class="tables-cell">
                <h3>Gistex Cileunyi</h3>
                <center><img class="span12" style="height:600px;width:800px"src="{{ public_path('rework/qc/images/'.$FinalFotoCLN['file']) }}"> </center>
            </div>
        </div>
        </div>
        @endif
        ...
        <div class="tables-row">
            <div class="tables-cell">
                <h3>Gistex Majalengka 1</h3>
                <center><img class="span12" style="height:600px;width:800px"src="{{ public_path('rework/qc/images/'.$FinalFotoGM1['file']) }}"> </center>
            </div>
        </div>
        </div>
        @endif
        ...
        <div class="tables-row">
            <div class="tables-cell">
                <h3>Gistex Majalengka 2</h3>
                <center><img class="span12" style="height:600px;width:800px"src="{{ public_path('rework/qc/images/'.$FinalFotoGM2['file']) }}"> </center>
            </div>
        </div>
        </div>
        @endif
