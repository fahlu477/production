                            ...
                            <div class="card-body" style="overflow:scroll;">
                                ...
                                <div class="row">
                                  ...
                                  <div class="div3 col-sm-2">
                                    <a href="{{ url('/rework/qc/images/'.$totalAgustus['file']) }}" data-toggle="lightbox" data-title="Agustus" data-gallery="gallery">
                                      <img src="{{ url('/rework/qc/images/'.$totalAgustus['file']) }}" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                  </div>
                                  @endif
                                  @if($totalSeptember['file'] != null)
                                  <div class="div3 col-sm-2">
                                    <a href="{{ url('/rework/qc/images/'.$totalSeptember['file']) }}" data-toggle="lightbox" data-title="September" data-gallery="gallery">
                                      <img src="{{ url('/rework/qc/images/'.$totalSeptember['file']) }}" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                  </div>
                                  @endif
                                  @if($totalOktober['file'] != null)
                                  <div class="div3 col-sm-2">
                                    <a href="{{ url('/rework/qc/images/'.$totalOktober['file']) }}" data-toggle="lightbox" data-title="Oktober" data-gallery="gallery">
                                      <img src="{{ url('/rework/qc/images/'.$totalOktober['file']) }}" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                  </div>
                                  @endif
                                  @if($totalNovember['file'] != null)
                                  <div class="div3 col-sm-2">
                                    <a href="{{ url('/rework/qc/images/'.$totalNovember['file']) }}" data-toggle="lightbox" data-title="November" data-gallery="gallery">
                                      <img src="{{ url('/rework/qc/images/'.$totalNovember['file']) }}" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                  </div>
                                  @endif
                                  @if($totalDesember['file'] != null)
                                  <div class="div3 col-sm-2">
                                    <a href="{{ url('/rework/qc/images/'.$totalDesember['file']) }}" data-toggle="lightbox" data-title="Desember" data-gallery="gallery">
                                      <img src="{{ url('/rework/qc/images/'.$totalDesember['file']) }}" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                  </div>
                                  @endif
                                </div>
                                ...
                                <form action="{{ route('tahunan.pdf')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                      ...
                                      <input type="hidden" name="branch_detail" id="branch_detail" value="{{$branch_detail}}">
