      ...
      <div class="container-fluid">
            ...
            <form action="{{ route('indah.harian')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggal" value="{{$tanggal}}" placeholder="Pilih Tanggal"  required/>
            ...
            <form action="{{ route('indah.bulanan')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="bulan"
            ...
            <div class="btn-group">
            <form action="{{ route('indah.Tdetail')}}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="form-group">
                <label>Tahun Vote</label>
                <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate2" name="tahun" placeholder="Pilih tahun"  value="{{$tahun}}" required/>
