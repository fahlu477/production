...
<head>
  ...
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="{{asset('/assets3/plugins/ekko-lightbox/ekko-lightbox.css')}}">
  <!-- Datatables -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{url('/assets3/dist/img/logo.png')}}" alt="SMQCLogo" height="60" width="60">
  </div>